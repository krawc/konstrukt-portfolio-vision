...
export const projectsRaw = [
  ...
  },
  {
    ...
    "description_html": `This project explores the concept of the 'digital panopticon' through an 8-hour performance experiment where every interaction with the web was recorded and transformed into algorithm-feeding data. It was later presented at a conference at the China Academy of Art in December 2021.<br/><br/><iframe width="100%" height="400" src="https://www.youtube.com/embed/Vs_y6PghD4s" title="iLiveInPublic" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe><br/><br/>In my work, I attempted to integrate the technique of disruption of the everyday reality to challenge the prosaic experience of my generational cohort. I sat within a glass enclosure in a public space on campus, only with my laptop, and proceeded to live a full 24 hours entirely visibly visible. A camera, located outside of the cubicle, was live-streaming the performance on Twitch. The laptop was used by me to complete various digital tasks, watch Netflix, browse Facebook, Google, Twitter, etc. all in the sight of the viewers online and in-person. A receipt of every website visit, every click and every field input on the browser was printed with a digital printer connected to a Chrome browser extension. The data was printed in a human-readable form, making it possible to directly interpret interactions and gain sensitive information from them. Moreover, the printer was located outside of my enclosure, making the information available for the public to read. The timed, gradual accumulation of data exhaust was accomplished beyond my own agency, which signified the objective but not directly wilful character of interaction tracking on the web. The availability of this data to the larger public caused a potential for interaction with the audience. Many viewers hesitantly started to approach the printer, grab the receipts and start reading. Is the sensitivity of handling personal data not precisely the problem that any person in charge of analytics and profiling should ponder on?<br/><br/>The other part of my digital data exposure involved processing the obscure data into "marketable" data. The textual exhaust was at all times linked to an IBM Watson personality prediction algorithm (same as the one used by Data Selfie). The API returned psychometric data related to the text across 56 parameters, including agreeableness, happiness, and the likelihood of questioning authority, among others. The results were displayed online through a Node.js instance, which was presented on a screen attached to the printer outside the booth.<br/><br/>The performance took 8 hours. The objective behind it was to signify the daily labor of producing data for technological companies. Brief 5-minute intermissions have been publicly announced as well, as in many ways, even a pause in activity, and its specific length, can be an important signifier of a user's personal profile. With these three components: timed exposure to the digital realm, consequential accumulation of data exhaust, and public release of personal information, the idea was to capture and challenge the new paradigm of public living among my generational cohort.`,
    "type": ["culture", "play"],
    "year": "2019",
    "images": [
